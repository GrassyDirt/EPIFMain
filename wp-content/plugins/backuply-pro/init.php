...
define('BACKUPLY_PRO_VERSION', '1.5.7');
define('BACKUPLY_PRO_DIR', dirname(BACKUPLY_PRO_FILE));
define('BACKUPLY_PRO_DIR_URL', plugin_dir_url(BACKUPLY_PRO_FILE));
...
add_filter('site_transient_update_plugins', 'backuply_pro_disable_manual_update_for_plugin', 99);
add_filter('pre_site_transient_update_plugins', 'backuply_pro_disable_manual_update_for_plugin', 99);
...
function backuply_pro_load_plugin(){
	...
	if(is_admin()){
		...
		// Admin-only code: ajax handlers, footer hooks, etc.
		include_once BACKUPLY_PRO_DIR . '/main/admin.php';
	}
