...
class Pro{
	...
	static function local_business_tab(){
		...
		$set_custom_schema_id = isset($options['custom_schema_id']) ? esc_attr($options['custom_schema_id']) : '';
		...
		echo'<table class="form-table">
			<tbody>
				...
				<tr><th scope="row" style="user-select: auto;">Custom Schema @id</th>
					<td><input type="text" name="siteseo_pro_options[custom_schema_id]" placeholder="eg: https://example.com/#dentist" value="'.esc_attr($set_custom_schema_id).'">
						<p class="description">' . esc_html__('Set a custom @id to link this Local Business schema with other schemas on the page.', 'siteseo-pro') . '</p>
					</td>
				</tr>
 ...
 deny from all
	...
	static function save_settings(){
		...
		if(isset($_POST['local_business_settings'])){
			...
			$options['custom_schema_id'] = !empty($_POST['siteseo_pro_options']['custom_schema_id']) ? sanitize_text_field(wp_unslash($_POST['siteseo_pro_options']['custom_schema_id'])) : '';
