...
define('SITESEO_PRO_VERSION', '1.4.1');
...
function sitseopro_load_plugin(){
	...
	// Register SiteSEO Pro abilities with the WordPress 6.9+ Abilities API.
	if(!empty($siteseo->setting_enabled['toggle-abilities']) && function_exists('wp_register_ability')){
		add_action('wp_abilities_api_categories_init', '\SiteSEOPro\AbilitiesRegister::register_categories');
		add_action('wp_abilities_api_init', '\SiteSEOPro\AbilitiesRegister::register_abilities');
	}
